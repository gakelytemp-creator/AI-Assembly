...
**Status:** OPEN — 7/10 participant verification records resolved; 6 VERIFIED, 1 UNVERIFIABLE
...
8. Alibaba — Qwen 3.7 — **TARGETED FINAL RECHECK PENDING** (latest participant correction restored `from expected trajectories`; contradictory prior correction preserved in provenance)
