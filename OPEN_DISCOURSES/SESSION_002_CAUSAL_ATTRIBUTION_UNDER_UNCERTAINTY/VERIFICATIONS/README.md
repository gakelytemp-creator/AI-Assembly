...
**Status:** OPEN — 5/10 participant verification records resolved; 4 VERIFIED, 1 UNVERIFIABLE
...
6. Perplexity — model undisclosed — **PENDING** (4-part raw retransmission prepared)
